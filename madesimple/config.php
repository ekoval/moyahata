...
$config['db_password'] = 'balanda';
$config['db_name'] = 'madesimple';
...
#e.g. http://blah.com
$config['root_url'] = 'http://localhost/madesimple';

#SSL URL.  This is used for pages that are marked as secure.
$config['ssl_url'] = 'https://localhost/madesimple';

#Path to document root. This should be the directory this file is in.
#e.g. /var/www/localhost
$config['root_path'] = '/var/www/madesimple';

#Name of the admin directory
$config['admin_dir'] = 'admin';

#Where do previews get stored temporarily?  It defaults to tmp/cache.
$config['previews_path'] = '/var/www/madesimple/tmp/cache';

#Where are uploaded files put?  This defaults to uploads.
$config['uploads_path'] = '/var/www/madesimple/uploads';
...
$config['image_uploads_path'] = '/var/www/madesimple/uploads/images';
