<?php /* Smarty version 2.6.25, created on 2011-07-28 15:20:31
         compiled from siteprefs.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'siteprefs.tpl', 26, false),array('modifier', 'lang', 'siteprefs.tpl', 101, false),)), $this); ?>
<?php $this->_cache_serials['/var/www/madesimple/tmp/templates_c/%%1B^1B2^1B2DE232%%siteprefs.tpl.inc'] = '93bfc4ab8ff59f5bab9bd5cc74a44871'; ?><?php echo $this->_tpl_vars['mod']->StartTabHeaders(); ?>
...
:</p>
	<p class="pageinput">
		...
		<?php if ($this->caching && !$this->_cache_including): echo '{nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#0}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('93bfc4ab8ff59f5bab9bd5cc74a44871','0');echo smarty_function_html_options(array('options' => $this->_tpl_vars['wysiwyg'],'selected' => $this->_tpl_vars['frontendwysiwyg']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#0}'; endif;?>
...
:</p>
  <p class="pageinput">
    <select name="logintheme">
      <?php if ($this->caching && !$this->_cache_including): echo '{nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#1}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('93bfc4ab8ff59f5bab9bd5cc74a44871','1');echo smarty_function_html_options(array('options' => $this->_tpl_vars['themes'],'selected' => $this->_tpl_vars['logintheme']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#1}'; endif;?>
...
:</p>
  <p class="pageinput">
    <select name="listcontent_showtitle">
      <?php if ($this->caching && !$this->_cache_including): echo '{nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#2}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('93bfc4ab8ff59f5bab9bd5cc74a44871','2');echo smarty_function_html_options(array('options' => $this->_tpl_vars['titlemenu'],'selected' => $this->_tpl_vars['listcontent_showtitle']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#2}'; endif;?>
...
:</p>
  <p class="pageinput">
    <select name="listcontent_showalias">
      <?php if ($this->caching && !$this->_cache_including): echo '{nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#3}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('93bfc4ab8ff59f5bab9bd5cc74a44871','3');echo smarty_function_html_options(array('options' => $this->_tpl_vars['yesno'],'selected' => $this->_tpl_vars['listcontent_showalias']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#3}'; endif;?>
...
:</p>
  <p class="pageinput">
    <select name="listcontent_showurl">
      <?php if ($this->caching && !$this->_cache_including): echo '{nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#4}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('93bfc4ab8ff59f5bab9bd5cc74a44871','4');echo smarty_function_html_options(array('options' => $this->_tpl_vars['yesno'],'selected' => $this->_tpl_vars['listcontent_showurl']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#4}'; endif;?>
...
:</p>
  <p class="pageinput">
    ...
    <?php if ($this->caching && !$this->_cache_including): echo '{nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#5}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('93bfc4ab8ff59f5bab9bd5cc74a44871','5');echo smarty_function_html_options(array('options' => $this->_tpl_vars['yesno'],'selected' => $this->_tpl_vars['content_autocreate_urls']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#5}'; endif;?>
...
:</p>
  <p class="pageinput">
    ...
    <?php if ($this->caching && !$this->_cache_including): echo '{nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#6}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('93bfc4ab8ff59f5bab9bd5cc74a44871','6');echo smarty_function_html_options(array('options' => $this->_tpl_vars['yesno'],'selected' => $this->_tpl_vars['content_autocreate_flaturls']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#6}'; endif;?>
...
:</p>
  <p class="pageinput">
    ...
    <?php if ($this->caching && !$this->_cache_including): echo '{nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#7}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('93bfc4ab8ff59f5bab9bd5cc74a44871','7');echo smarty_function_html_options(array('options' => $this->_tpl_vars['yesno'],'selected' => $this->_tpl_vars['content_mandatory_urls']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#7}'; endif;?>
...
:</p>
  <p class="pageinput">
    <select name="basic_attributes[]" multiple="multiple" size="5">
      <?php if ($this->caching && !$this->_cache_including): echo '{nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#8}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('93bfc4ab8ff59f5bab9bd5cc74a44871','8');echo smarty_function_html_options(array('options' => $this->_tpl_vars['all_attributes'],'selected' => $this->_tpl_vars['basic_attributes']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#8}'; endif;?>
...
:</strong>&nbsp;<?php echo $this->_supers['server']['REMOTE_ADDR']; ?>
<br/>
...
:</p>
  <p class="pageinput">
    ...
    <?php if ($this->caching && !$this->_cache_including): echo '{nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#9}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('93bfc4ab8ff59f5bab9bd5cc74a44871','9');echo smarty_function_html_options(array('options' => $this->_tpl_vars['pseudocron_options'],'selected' => $this->_tpl_vars['pseudocron_granularity']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:93bfc4ab8ff59f5bab9bd5cc74a44871#9}'; endif;?>
