<?php /* Smarty version 2.6.25, created on 2011-07-28 15:35:50
         compiled from module_file_tpl:TinyMCE%3Btinyconfig.tpl */ ?>
<?php if ($this->_tpl_vars['avoidlinkconversion'] == '1'): ?>
<?php echo '
...
<?php echo $this->_tpl_vars['module_plugins']; ?>
",
  ...
  <?php if ($this->_tpl_vars['allowresizing'] != 'none'): ?>
  theme_advanced_resizing : true,
    <?php if ($this->_tpl_vars['allowresizing'] == 'height'): ?>
...
function CMSMSFilePicker (field_name, url, type, win) {
  ...
  var cmsURL = "<?php echo $this->_tpl_vars['filepickerurl']; ?>
