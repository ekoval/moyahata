...
if ( version_compare( $required_php_version, phpversion(), '>' ) )
	wp_die( sprintf( /*WP_I18N_OLD_PHP*/'Ваш сервер використовує %1$s версію PHP, але WordPress %2%s працює із > %2%s.'/*/WP_I18N_OLD_PHP*/, phpversion(), $required_php_version ) );

if ( !extension_loaded('mysql') && !file_exists(ABSPATH . 'wp-content/db.php') )
	wp_die( /*WP_I18N_OLD_MYSQL*/'Здається, у Вашого сервера відсутня зв’язка PHP—MYSQL, яка потрібна для роботи WordPress.'/*/WP_I18N_OLD_MYSQL*/ );
...
<?php
	...
	if ( preg_match( '|[^a-z0-9_]|i', $prefix ) )
		wp_die( /*WP_I18N_BAD_PREFIX*/'<strong>ПОМИЛКА</strong>: Префікс таблиці може містити ЛИШЕ цифри, букви і нижнє підкреслення.'/*/WP_I18N_BAD_PREFIX*/ );
